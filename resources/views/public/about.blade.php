...
<div class="py-24 max-w-4xl mx-auto px-4">
    ...
    <div class="text-stone-400 space-y-6 leading-relaxed">
        <p>MORE Hair Studio was established with a singular vision: to deliver precision hair styling and custom organic treatments in a high-fidelity, luxury environment.</p>
