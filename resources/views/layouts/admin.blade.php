    ...
    <div class="flex-grow flex flex-col min-w-0">
        ...
        <header class="h-20 bg-white border-b border-stone-200 flex items-center justify-between px-4 lg:px-8 shrink-0">
            <div class="flex items-center space-x-3 min-w-0">
                ...
                <h1 class="text-xs sm:text-sm md:text-base font-bold uppercase tracking-wider font-mono text-stone-850 truncate font-display">@yield('page_title', 'Control Center')</h1>
            </div>
