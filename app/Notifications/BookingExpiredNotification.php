...
class BookingExpiredNotification extends Notification implements ShouldQueue
{
    ...
    public function toWhatsApp($notifiable): array
    {
        ...
        $message = "Booking Anda telah melewati batas waktu check-in.\n\n" .
                   "• *Booking*: {$this->booking->booking_code}\n" .
                   "• *Jadwal*: {$formattedDate}, {$startTime} WIB\n\n" .
                   "Silakan melakukan booking kembali apabila ingin mendapatkan jadwal berikutnya.";
