        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div class="max-w-2xl space-y-3">
                ...
                <p class="text-sm text-stone-600 font-light leading-relaxed">
                    Lebih dari barbershop biasa: ruang dialog dan dokumentasi subkultur urban Kota Bandung.
                </p>
            </div>
            <span class="text-xs font-mono text-stone-400 font-medium">Chapter 7 Brand Book</span>
        </div>

        <!-- 7 Pillars Grid (Clean, Frameless Cards) -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            
            <!-- Pillar 1: Define Session -->
            <div class="bg-stone-50/70 p-7 rounded-2xl flex flex-col justify-between hover:bg-stone-100/60 transition duration-300 group">
                ...
                <span class="text-[10px] font-mono text-[#c9512d] pt-6 block">
                    Editorial Interview
                </span>
            </div>
            ...
            <div class="bg-stone-50/70 p-7 rounded-2xl flex flex-col justify-between hover:bg-stone-100/60 transition duration-300 group">
                ...
                <span class="text-[10px] font-mono text-stone-500 pt-6 block">
                    Craftsmanship Detail
                </span>
            </div>

            <!-- Pillar 3: Human Hair Edu -->
            <div class="bg-stone-50/70 p-7 rounded-2xl flex flex-col justify-between hover:bg-stone-100/60 transition duration-300 group">
                <div class="space-y-3">
            ...
            <div class="bg-stone-50/70 p-7 rounded-2xl flex flex-col justify-between hover:bg-stone-100/60 transition duration-300 group sm:col-span-2 lg:col-span-2">
                ...
                <span class="text-[10px] font-mono text-[#c9512d] pt-6 block">
                    Urban Culture &bull; Local Pride
                </span>
            </div>
