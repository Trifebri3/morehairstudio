...
<div class="py-24 max-w-4xl mx-auto px-4">
    ...
    <div class="text-stone-400 space-y-6 text-sm leading-relaxed">
        <p>At MORE Hair Studio, we respect your privacy. We collect personal details (name, normalized phone, email, date of birth) to process bookings, validate promo eligibility, and send notifications.</p>
