<section class="py-20 bg-white border-b border-stone-200 relative overflow-hidden font-sans">
    <div class="max-w-4xl mx-auto px-4 text-center relative z-10 space-y-6">
        ...
        <div class="pt-2">
            <a href="{{ route('booking.index') }}" class="inline-flex items-center px-8 py-3.5 rounded-xl font-mono text-xs font-bold uppercase tracking-wider border border-[#c9512d] text-[#c9512d] hover:bg-[#c9512d] hover:text-white transition duration-200 shadow-2xs">
                Share Your Feedback
            </a>
        </div>
    </div>
