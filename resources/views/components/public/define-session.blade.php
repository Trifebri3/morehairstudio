<section class="py-16 md:py-20 bg-white border-b border-stone-200 font-sans">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="border border-stone-200 rounded-[2.5rem] p-8 sm:p-12 md:p-16 bg-[#fafaf9] relative overflow-hidden">
            
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                
                <!-- Left Column: Story & Benefit (7 cols) -->
                <div class="lg:col-span-7 space-y-6">
                    ...
                    <div class="pt-4 flex items-center gap-4 text-xs font-mono">
                        <a href="{{ route('booking.index', ['service_id' => 5]) }}" class="px-6 py-3 rounded-xl bg-[#c9512d] hover:bg-[#b74423] text-white font-bold uppercase tracking-wider transition shadow-sm">
                            Coba Define Session &rarr;
                        </a>
                        <span class="text-stone-400 uppercase tracking-widest text-[10px]">Termasuk dalam semua layanan Haircut</span>
                    </div>
