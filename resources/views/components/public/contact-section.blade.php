        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-3 pt-2">
                    <div class="flex items-center space-x-3 text-xs text-stone-700 font-medium font-mono">
                        <span class="font-bold uppercase text-[10px] tracking-wider text-stone-400 block min-w-[60px]">Email:</span>
                        <span>contact@morehairstudio.com</span>
                    </div>
                    <div class="flex items-center space-x-3 text-xs text-stone-700 font-medium font-mono">
                        <span class="font-bold uppercase text-[10px] tracking-wider text-stone-400 block min-w-[60px]">Hours:</span>
            ...
            <div class="border border-stone-200 p-8 rounded-3xl bg-white space-y-4 hover:border-[#c9512d]/40 transition duration-300 shadow-xs">
                ...
                <div class="space-y-1">
                    <label class="block text-[10px] uppercase tracking-widest text-stone-500 font-bold font-mono">Email / WhatsApp</label>
                    <input type="text" placeholder="0812xxxx / email@example.com" class="w-full px-4 py-3 bg-white border border-stone-200 rounded-xl text-xs text-stone-900 placeholder-stone-400 focus:outline-none focus:border-[#c9512d] transition duration-200">
                </div>
                <div class="space-y-1">
